...
def one_train():
	...
	for retrain_datafile in os.listdir(datafile_base):
            if fnmatch.fnmatch(retrain_datafile, "nx_{}_ny_2_from_1_wpfile_spd_{}*66000*friction_safe_150cm_run*.csv".format(\
	...
	load_MLP_model_path = './checkpoints/mlp_dict_nx={}_wps{}_spd_{}_lr{}_bs{}_optim{}_ep90999_friction_safe_150cm_train_ep92000.pth'.format(\
	...
	#loss_values = checkpoint['loss_values']
	loss_values = None
	save_MLP_model_path = './checkpoints/mlp_model_nx={}_wps{}_spd_{}_lr{}_bs{}_optim{}_ep{}_friction_safe_150cm_train.pth'.format(\
...
def enhance_train(prev_epoch, from_epoch, to_epoch):
	...
	datafile_base = './datasets/'
	for retrain_datafile in os.listdir(datafile_base):
            if fnmatch.fnmatch(retrain_datafile, "nx_{}_ny_2_from_1_wpfile_spd_{}*ep_{}_friction_safe_150cm_enhance*.csv".format(\
	...
	train_loader = get_data_loaders(retrain_datafiles, batch_size, num_wps)
	#MLP_model_path = "/home/depend/workspace/carla/PythonAPI/synchronous_mode/models/mlp/dest_start_merge_models/mlp_dict_nx=8_wps5_lr0.001_bs32_optimSGD_ep100_ep200_ep300_ep400_ep500_ep600_ep700_ep800_ep900_ep1000.pth"
	load_MLP_model_path = './checkpoints/mlp_dict_nx={}_wps{}_spd_{}_lr{}_bs{}_optim{}_ep{}_friction_safe_150cm_train_ep{}.pth'.format(\
