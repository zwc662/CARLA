...
"""RH: duplicate from local_planner.py and return both the control and future_wps"""
...
class LocalPlanner(object):
    ...
    def run_step(self, debug=True):
        ...
        return control, self.target_waypoint # TODO: see how to extend the horizon, since buffer is not of a constant size
